...
def int_func(word):
    """
    Капитализация аргумента функции
    :param word: Слово латиницей малыми буками
    :return: Возвращает исхожное слово с злавной первой буквой
    """
    return word.capitalize()

w = input("Слово латиницей: ")
print(int_func(w))

s = input("Строка из слов на латинице: ")
print(' '.join(map(int_func,s.split())))
